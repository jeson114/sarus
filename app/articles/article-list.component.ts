...
export class ArticleListComponent implements OnInit {
    ...
    constructor(private service: ArticleService, private renderer: Renderer) {
  
    }
    setItemClass(e) {
        console.log(e);
        if (e.value) {
            this.renderer.setElementProperty(e.target, 'className', 'item active');
        } else {
            this.renderer.setElementProperty(e.target, 'className', 'item inactive');
        }
    }
    ngOnInit() {
        this.articles = [];
